...
CrossBuilder::CrossBuilder(int width, int height):m_currentMap(NULL){
    m_width = width;
    m_height = height;
...
void CrossBuilder::buildMap(ObjectFactory& factory){
    //left wall
    ...
    factory.createWallBlock(m_width / 2 + sideWallTickness * 5, m_height /2 , sideWallTickness * 6, sideWallTickness );
...
void CrossBuilder::buildBlock(ObjectFactory& factory, QWidget *game){
...
void CrossBuilder::buildPlatform(ObjectFactory& factory){
...
void CrossBuilder::buildBall(ObjectFactory& factory){
